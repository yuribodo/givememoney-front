...
export function HeroSection() {
  ...
  const handleMouseMove = useCallback((e: React.MouseEvent<HTMLElement>) => {
    ...
    // Ativa hover no primeiro movimento do mouse (caso já esteja dentro da section)
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[800px] mx-auto text-center z-10 w-full">
        ...
        >
          Be the first to know when we launch. Get early access to crypto donations for streamers.
        </p>

        {/* Waitlist Form */}
        <div className="hero-cta opacity-0 mb-16">
          <WaitlistForm />
        </div>
